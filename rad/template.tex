...
\begin{figure}[H]
    \centering
    \subfigure{\includegraphics[width=0.22\textwidth]{ward-14-best.png}} 
    \subfigure{\includegraphics[width=0.22\textwidth]{ward-15-best.png}} 
    \subfigure{\includegraphics[width=0.22\textwidth]{ward-206-best.png}}
    \subfigure{\includegraphics[width=0.22\textwidth]{ward-207-best.png}}
    \caption{ Vizuelizacija rezultata klasterovanja koriscenjem hijerarhijskog klasterovanja i ward-ove veze }
    \label{fig:best_ward}
\end{figure}
...
\caption{ Rezultati birch algoritma klasterovanja: rezultati nisu jednoglasni i postoje razlike medju ocenama. Naime, najbolji koeficijent senke ima klasterovanje datoteke GSM3316207 koriscenjem euklidskog rastojanja, ali klasterovanje datoteke GSM3308814 ima bolji Calinski-Harabasz indeks i Davies-Bouldin indeks i Za Davies-Bouldin indeks postoji bolje klasterovanje, smatrace se da je ovo klasterovanje najbolje. }
\label{tab:birch-results}
\end{table}
